...
3. If Python is already not installed on computer then use following commands to install Python and then configure R to use Python installation. 
...
2.  Set a random odd number as a seed in the set.seed
    function to reproduce the results of this workflow. If you use seed number other than 1979, your results will be slightly different than the discusseed in the following text.
